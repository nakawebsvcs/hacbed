/**
 * BOARD MEMBERS DATA FILE
 *
 * HOW TO EDIT:
 * 1. To add a new team member: Copy an existing entry and paste it at the end of the array
 * 2. To remove a team member: Delete their entire entry (everything between and including the curly braces {})
 * 3. To update information: Simply edit the text between the quotes for any property
 * 4. To update photos: Upload new photos to the /public/assets/images/ folder and update the imageUrl path
 *
 * NOTE: Don't forget to add/remove commas as needed between entries!
 */
